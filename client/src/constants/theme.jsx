...
export const categoryColors = {
  ...
  INSURANCE: {
    ...
    bg: 'bg-[var(--system-pink)]/10',
    text: 'text-[var(--system-pink)]'
  },
  OTHER: {
    color: 'var(--system-gray)',
    bg: 'bg-[var(--system-gray)]/10',
    text: 'text-[var(--system-gray)]'
  },
};

// Category icons using SF Symbols style (Heroicons)
...
// Animation timing constants (Apple HIG compliant)
export const ANIMATION = {
  STAGGER_DELAY: 0.04,      // 40ms between items
